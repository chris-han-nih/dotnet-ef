...
namespace break_away.Migrations
{
    ...
    [Migration("20230618034856_AddInternetSpecialClass")]
    partial class AddInternetSpecialClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("break_away.Models.InternetSpecial", b =>
                {
                    b.Property<int>("InternetSpecialId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InternetSpecialId"));
                    ...
                    b.HasKey("InternetSpecialId");

                    b.HasIndex("AccommodationId");

                    b.ToTable("InternetSpecials");
                });
            ...
            modelBuilder.Entity("break_away.Models.InternetSpecial", b =>
                {
                    b.HasOne("break_away.Models.Lodging", "Accommodation")
                        .WithMany()
            ...
            modelBuilder.Entity("break_away.Models.Lodging", b =>
                {
                    b.HasOne("break_away.Models.Destination", null)
                        .WithMany("Lodgings")
